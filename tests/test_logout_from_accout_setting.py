...
def test_logout_from_accout_setting(driver, pre_email, pre_password):
    ...
    WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH, locators.locators_logout_button)))

    # нажимаем кнопку Выход
    driver.find_element(By.XPATH, locators.locators_logout_button).click()
