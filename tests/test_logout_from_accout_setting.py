...
def test_logout_from_accout_setting():
    ...
    WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH, "//*[@id='root']/div/main/div/nav/ul/li["
                                                                                "3]/button[text()='Выход']")))

    # нажимаем кнопку Выход
    driver.find_element(By.XPATH, "//*[@id='root']/div/main/div/nav/ul/li[3]/button[text()='Выход']").click()
